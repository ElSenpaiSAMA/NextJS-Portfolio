            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ flexShrink: 0, width: "180px" }}>
                  <p style={{ fontFamily: S, fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.09em", color: "#4a4540", marginBottom: "14px" }}>
                    Find me at
                  </p>
                  <div style={{ display: "flex", flexDirection: "column" }}>
                    {CONTACT_LINKS.map(({ label, value, href, external }, i) => (
                      ...
                      >
                        ...
                        <span style={{ fontFamily: S, fontSize: "12px", color: "#9C988E", wordBreak: "break-all" }}>{value}</span>
                      </a>
                    ))}
                  </div>
                </div>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ position: "relative" }}>
                    ...
                    >
                      ...
                      <div>
                        <label style={{ fontFamily: S, display: "block", fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.08em", color: "#6E6A62", marginBottom: "5px" }}>Message</label>
