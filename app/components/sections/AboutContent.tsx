  ...
  return (
    <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", padding: "80px 8% 24px", overflowY: "auto" }}>
      <div style={{ marginBottom: "24px", flexShrink: 0 }}>
        <h2 style={{ fontFamily: F, fontSize: "clamp(38px, 4.5vw, 60px)", fontWeight: 400, color: "#1B1A17", letterSpacing: "-0.03em", margin: "0 0 10px", lineHeight: 1 }}>About</h2>
        <div style={{ width: "36px", height: "1px", background: "#A8642E" }} />
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", flexShrink: 0 }}>
        ...
        <div style={{ ...PANEL, padding: "24px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "14px", marginBottom: "18px" }}>
            <div style={{ width: "52px", height: "52px", borderRadius: "50%", overflow: "hidden", border: "1px solid #E7E4DC", flexShrink: 0 }}>
              <img src="/104552415.jpg" alt="Matias" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </div>
            <div>
              <h3 style={{ fontFamily: F, fontSize: "20px", color: "#1B1A17", fontWeight: 400, letterSpacing: "-0.02em", margin: 0 }}>Matias Speroni</h3>
          ...
          <p style={{ fontFamily: S, fontSize: "13px", color: "#6E6A62", lineHeight: 1.7, marginBottom: "10px" }}>
          ...
          <div style={{ marginTop: "16px", paddingTop: "14px", borderTop: "1px solid #E7E4DC", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" }}>
            {[
              ...
              <div key={label}>
                <p style={{ fontFamily: S, fontSize: "10px", color: "#9C988E", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: "2px" }}>{label}</p>
                <p style={{ fontFamily: S, fontSize: "12px", color: "#1B1A17", fontWeight: 500 }}>{value}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            {STACK_TABS.map(({ key, label }) => (
              <button
                ...
                style={{
                  ...
                  background:  activeTab === key ? "#1B1A17" : "transparent",
                  color:       activeTab === key ? "#FBFAF7" : "#9C988E",
                  border:      activeTab === key ? "1px solid #1B1A17" : "1px solid #E7E4DC",
                }}
              >
                {label}
              </button>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "7px" }}>
            {items.map((name) => (
              <div key={name} style={{ ...PANEL, padding: "11px 8px", textAlign: "center" }}>
                <div style={{ width: "4px", height: "4px", borderRadius: "50%", background: "#A8642E", margin: "0 auto 6px" }} />
                <p style={{ fontFamily: S, fontSize: "11px", color: "#1B1A17", fontWeight: 500, margin: 0 }}>{name}</p>
              </div>
            ))}
          </div>
        </div>
