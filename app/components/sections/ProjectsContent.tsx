  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: "24px", flexShrink: 0 }}>
        ...
        <div style={{ width: "44px", height: "1px", background: "#A8642E", opacity: 0.6 }} />
      </div>
          ...
          <article key={p.id} style={PANEL}>
            ...
            <div style={{ padding: "14px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "5px" }}>
                <p style={{ fontFamily: F, fontSize: "16px", color: "#e8e4dc", letterSpacing: "-0.01em", margin: 0 }}>{p.title}</p>
                {p.inDevelopment && (
                  <span style={{ fontFamily: S, fontSize: "9px", color: "#6E6A62", textTransform: "uppercase", letterSpacing: "0.08em" }}>WIP</span>
                )}
              </div>
              ...
              <div style={{ display: "flex", gap: "7px" }}>
                {p.github && (
                  <a href={p.github} target="_blank" rel="noopener noreferrer" style={{
                    fontFamily: S, fontSize: "10px", color: "#9C988E", textDecoration: "none",
                ...
                {p.siteLink && (
                  <a href={p.siteLink} target="_blank" rel="noopener noreferrer" style={{
                    ...
                    background: "rgba(168,100,46,0.18)", border: "1px solid rgba(168,100,46,0.3)",
